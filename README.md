...
#### Параметры обучения:
- Количество эпох: 100 (в силу ограниченности ресурсов обучил 15 на протяжении больше 6 часов (в силу того, что случайно удалил большую часть кода при попытке пуша осталась версия весом модели для 9 эпох, для 15 остался лишь вывод в обучении)  
- Размер батча: 8
...
По результатам обучения достигнуты следующие показатели (для 15 эпох):  
P          R          mAP50     mAP50-95  
0.796      0.599      0.717      0.449    

Для 9 эпох:  
0.798      0.584      0.706      0.439
...
1. Пользователь может загрузить изображение, видеофайл или запустить веб-камеру.  
...
- Выбор типа входных данных (изображение/видео/веб-камера)  
